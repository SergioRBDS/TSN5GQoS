...
UL = "resultsCSV/DL2-100s.csv"
UEUE = "resultsCSV/DL3-100s.csv"
...
# Criando o gráfico de violino com todos os dados lado a lado
plt.figure(figsize=(12, 6))
sns.violinplot(x='case', y='vecvalue', data=combined_df, palette=c, cut=0)
...
# Salvar o gráfico
plt.savefig("TimeSync1_Comparison100_violin.pdf")
plt.show()
