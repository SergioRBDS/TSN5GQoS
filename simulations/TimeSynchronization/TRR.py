...
def process_file(filepath):
    ...
    df['vecvalue'] = df['vecvalue'].apply(lambda x: [1.+float(i) for i in x.strip('[]').split()])
...
# Arquivos e labels
DL = "resultsCSV/DL2-RR.csv"
UL = "resultsCSV/UL2-RR.csv"
UEUE = "resultsCSV/UEUE2-RR.csv"
...
# Salvar o gráfico
plt.savefig("RR2_Comparison.pdf")
plt.show()