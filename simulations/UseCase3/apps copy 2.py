...
# Arquivos e labels
No = "resultsCSV/TimeDelayCommon.csv"
QFI = "resultsCSV/TimeDelayQFI.csv"

arqs = [No, QFI]
labels = ["Not considering", "QFI = 86"]
c = ["green", "orange"]
...
plt.title("Comparing the use of QoS mapping",fontsize=18)
plt.xlabel('')
plt.ylabel('End-to-end delay (s)', fontsize=24)
